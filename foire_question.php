        ...
        <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    ...
                    <ul>
                        <li>Le plus simple pour vous est de payer par <strong>prélèvement mensuel</strong> ou à chaque facture pour être sûr de ne pas laisser passer l'échéance.</li>
                        <li>Vous pouvez également opter pour le <strong>paiement sécurisé par carte bancaire</strong> en ligne. Pour ces trois options, il vous suffit d'avoir créé votre espace client.</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="accordion-item">
            ...
            <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    ...
                    <br>
                    Une pression « confortable » se situe <strong>entre 2 et 3 bars</strong>. Si la pression est supérieure à 3 bars, nous vous conseillons de protéger vos installations par la pose d'un réducteur de pression.
                    <br>
        ...
        <div class="accordion-item">
            ...
            <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    ...
                    <br>
                    La mise en service du branchement est effectuée par les agents du service des Eaux, seuls habilités à manœuvrer les robinets de prise en charge sur la conduite de distribution.                </div>
            </div>
        </div>
    </div>
</div>
