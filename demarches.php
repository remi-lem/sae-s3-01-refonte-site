...
<h1 id="titre-toutes-demarches">Mes démarches</h1>
<div id="conteneur-toutes-demarches">
    <div class="orientation-conteneur" id="demarches-en-bref-dessus">
        <div id="demarches-en-bref">
            <h2 id="titre-demarches-en-bref">Mes démarches en bref</h2>
            <div class="conteneur row g-0">
                ...
                <div class="demarches col-12 col-md-6 col-lg-4">
                    <h2>Demande de CNI/passeport</h2>
